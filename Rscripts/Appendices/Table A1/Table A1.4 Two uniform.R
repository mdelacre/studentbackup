##################################################################################################################################
#                                 BALANCED DESIGNS WITH S1 = UNIF(0,2) ; S2 = UNIF(0,2*SDR)                                      #
##################################################################################################################################
...
###### n=10
	...
	alpha_bis=function(SDR){ 
		...
		generate=function(i){
			...
			sample2 <- runif(n,SDR*-3.465,SDR*3.465) #simulate participants condition B, as a default option, mean = 0
	...
	write.table(alpha_rate,paste("Alpha extr SDR_balanced design_Two uniform_n1=n2=",alpha_rate[1],".txt"),sep=";",dec=",")
...
###### n=10
	...
	power_bis=function(SDR){ 
		...
		generate=function(i){
			...
			sample1 <- runif(n,-2.465,4.465) #simulate participants condition A, mean = 1
			sample2 <- runif(n,SDR*-3.465,SDR*3.465) #simulate participants condition B, as a default option, mean = 0
	...
	write.table(power_rate,paste("Power extr SDR_balanced_Two unif_n1=n2=",power_rate[1],".txt"),sep=";",dec=",")
