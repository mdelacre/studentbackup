...
plot(n1_60_n2_40_SDR_1[,1],n1_60_n2_40_SDR_1[,2],ylim=c(0,1),xlim=c(0,1),xlab="p-values from Student's t-test", ylab="p-values from Welch's t-test",col="grey63",
main=paste("Figure 3a:","\n","n1=60   n2=40   SDR = 1"),cex=0.5, cex.axis=1.3,cex.lab=1.3)
...
plot(n1_50_n2_50_SDR_2[,1],n1_50_n2_50_SDR_2[,2],ylim=c(0,1),xlim=c(0,1),xlab="p-values from Student's t-test", ylab="p-values from Welch's t-test",col="grey63",
main=paste("Figure 3b:","\n","n1=n2=50   SDR = 2"),cex=0.5, cex.axis=1.3,cex.lab=1.3)
abline(h=0.05) #0.05 line for Welch's test
abline(v=0.05) #0.05 line for Student's t 
abline(0,1, col="black", lwd=2) #draw diagonal red line
dev.off()
...
plot(n1_40_n2_60_SDR_2[,1],n1_40_n2_60_SDR_2[,2],ylim=c(0,1),xlim=c(0,1),xlab="p-values from Student's t-test", ylab="p-values from Welch's t-test",col="grey63",
main=paste("Figure 3c:","\n","n1=40   n2=60   SDR = 2"),cex=0.5, cex.axis=1.3,cex.lab=1.3)
abline(h=0.05) #0.05 line for Welch's test
abline(v=0.05) #0.05 line for Student's t 
abline(0,1, col="black", lwd=2) #draw diagonal red line
dev.off()
...
plot(n1_40_n2_60_SDR_0.5[,1],n1_40_n2_60_SDR_0.5[,2],ylim=c(0,1),xlim=c(0,1),xlab="p-values from Student's t-test", ylab="p-values from Welch's t-test",col="grey63",
main=paste("Figure 3d:","\n","n1=40   n2=60   SDR = 0.5"),cex=0.5, cex.axis=1.3,cex.lab=1.3)
abline(h=0.05) #0.05 line for Welch's test
abline(v=0.05) #0.05 line for Student's t 
abline(0,1, col="black", lwd=2) #draw diagonal red line
dev.off()
