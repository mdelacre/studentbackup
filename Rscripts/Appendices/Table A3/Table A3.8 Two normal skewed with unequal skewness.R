...
setwd(dir="C:/Users/Admin/Documents/Github projects/studentbackup/scripts outputs/Appendices/Table A3/Table A3.8 Two normal skewed with unequal skewness")
...
###### n=10 and r=0.5
	...
	write.table(alpha_rate,paste("Unequal skewnorm_n1=",alpha_rate[1,2],"and r=",alpha_rate[1,3],".txt"),sep=";",dec=",")
