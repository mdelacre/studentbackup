##################################################################################################################################
#                                 BALANCED DESIGNS WITH S1 = N(0,2) ; S2 = DOUBLEX(0,2*SDR)                                      #
##################################################################################################################################
...
setwd(dir="C:/Users/Admin/Documents/Github projects/studentbackup/scripts outputs/Appendices/Table A1/Table A1.3 One normal, one double exponential")
...
###### n=10
	...
	alpha_bis=function(SDR){ 
		...
		generate=function(i){
			...
			sample1 <- rnorm(n, mean=0, sd=2) #simulate participants condition A, as a default option, mean = 0
	...
	write.table(alpha_rate,paste("Alpha extr SDR_balanced_normal and doublex_n1=n2=",alpha_rate[1],".txt"),sep=";",dec=",")
...
###### n=10
	...
	write.table(power_rate,paste("Power extr SDR_balanced_norm and doublex_n1=n2=",power_rate[1],".txt"),sep=";",dec=",")
