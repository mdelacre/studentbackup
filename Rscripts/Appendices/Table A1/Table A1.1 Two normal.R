##################################################################################################################################
#                                 BALANCED DESIGNS WITH  S1 = N(0,2) ; S2 = N(0,2*SDR)                                           #
##################################################################################################################################
...
###### n=10
	...
	write.table(alpha_rate,paste("Alpha extr SDR_balanced design_two normal_n1=n2=",alpha_rate[1],".txt"),sep=";",dec=",")
...
###### n=10
	...
	write.table(power_rate,paste("Power extr SDR_balanced_two normal_n1=n2=",power_rate[1],".txt"),sep=";",dec=",")
