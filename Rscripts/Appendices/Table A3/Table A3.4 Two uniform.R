##############################################################
# PART 1: ALPHA RISK : S1 = Unif(0,2) ; S2 = Unif(0,2*ratio) #
##############################################################
...
setwd(dir="C:/Users/Admin/Documents/Github projects/studentbackup/scripts outputs/Appendices/Table A3/Table A3.4 Two uniform distributions")
...
###### n=10 and r=0.5
	...
	write.table(alpha_rate,paste("Two uniform,n1=",alpha_rate[1,2],"and r=",alpha_rate[1,3],".txt"),sep=";",dec=",")
