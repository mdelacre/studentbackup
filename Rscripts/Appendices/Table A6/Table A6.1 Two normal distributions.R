...
setwd(dir="C:/Users/mdela/Dropbox/Welch vs. Students_final Scripts/Table A3 power for distributions/With extreme SDR/Normal")
...
###### n=10 and r=1
	...
	write.table(power_rate,paste("Extr and very extr SDR_Two normal_n1=",power_rate[1,2],"and r=",power_rate[1,3],".txt"),sep=";",dec=",")
