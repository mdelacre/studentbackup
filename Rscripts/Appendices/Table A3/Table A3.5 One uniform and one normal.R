...
setwd(dir="C:/Users/mdela/Dropbox/Welch vs. Students_final Scripts/Table A3 for different non normal distributions/Middle to big SS/Uniform and normal")
...
###### n=10 and r=0.5
	...
	alpha_bis=function(ratio){
		...
		generate=function(i){
			...
			sample2 <- rnorm(r*n1,sd=2*ratio) #simulate participants condition B, as a default option, mean = 0
	...
	write.table(alpha_rate,paste("Uniform and normal_n1=",alpha_rate[1,2],"and r=",alpha_rate[1,3],".txt"),sep=";",dec=",")
