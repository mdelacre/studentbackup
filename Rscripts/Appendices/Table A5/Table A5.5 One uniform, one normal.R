##############################################
# POWER : S1 = Unif(0,2) ; S2 = N(1,2*ratio) #
##############################################
...
setwd(dir="C:/Users/ULB/Dropbox/Welch vs. Students_final Scripts/Table A3 power for distributions/Medium to large SS/Uniform and normal")
...
###### n=10 and r=0.5
	...
	write.table(power_rate,paste("Uniform and normal_n1=",power_rate[1,2],"and r=",power_rate[1,3],".txt"),sep=";",dec=",")
