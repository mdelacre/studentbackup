##################################################################################################################################
#                                BALANCED DESIGNS WITH  S1 = UNIF(0,2) ; S2 = N(0,2*SDR)                                         #
##################################################################################################################################
...
setwd(dir="C:/Users/Admin/Documents/Github projects/studentbackup/scripts outputs/Appendices/Table A1/Table A1.5 One uniform, one normal")
...
###### n=10
	...
	alpha_bis=function(SDR){ 
		...
		generate=function(i){
			...
			sample2 <- rnorm(n,0,sd=2*SDR) #simulate participants condition B, as a default option, mean = 0
	...
	write.table(alpha_rate,paste("Alpha extr SDR_balanced_uniform and normal_n1=n2=",alpha_rate[1],".txt"),sep=";",dec=",")
...
###### n=10
	...
	power_bis=function(SDR){ 
		...
		generate=function(i){
			...
			sample1 <- runif(n,-3.465,3.465) #simulate participants condition A, as a default option, mean = 0
			sample2 <- rnorm(n,1,sd=2*SDR) #simulate participants condition B, mean = 1
	...
	write.table(power_rate,paste("Power extr SDR_balanced_unif and norm_n1=n2=",power_rate[1],".txt"),sep=";",dec=",")
