...
###### n=10
	...
	alpha_bis=function(SDR){ 
		...
		generate=function(i){
			...
			sample1 <- rdoublex(n, mu=0, 2) #simulate participants condition A, as a default option, mean = 0
			sample2 <- rdoublex(n, mu=0, SDR*2)#simulate participants condition B, as a default option, mean = 0
