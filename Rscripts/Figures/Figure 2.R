...
par(mfrow=c(2,1))
hist(n1_60_n2_40_SDR_1[,1], main=substitute(paste("Student's ",italic('t-'), "test")), xlab=substitute(paste("Observed ",italic('p-'), "value")))
hist(n1_60_n2_40_SDR_1[,2], main=substitute(paste("Welch's ",italic('t-'), "test")),xlab=substitute(paste("Observed ",italic('p-'), "value")))
dev.off()

#FIGURE 2B: now plot the histogram for p-value distributions
png("Figure2B.png",width=2000,height=2000, res = 300)
par(mfrow=c(2,1))
hist(n1_50_n2_50_SDR_2[,1], main=substitute(paste("Student's ",italic('t-'), "test")), xlab=substitute(paste("Observed ",italic('p-'), "value")))
hist(n1_50_n2_50_SDR_2[,2], main=substitute(paste("Welch's ",italic('t-'), "test")),xlab=substitute(paste("Observed ",italic('p-'), "value")))
dev.off()

#FIGURE 2C:now plot the histogram for p-value distributions
png("Figure2C.png",width=2000,height=2000, res = 300)
par(mfrow=c(2,1))
hist(n1_40_n2_60_SDR_2[,1], main=substitute(paste("Student's ",italic('t-'), "test")), xlab=substitute(paste("Observed ",italic('p-'), "value")))
hist(n1_40_n2_60_SDR_2[,2], main=substitute(paste("Welch's ",italic('t-'), "test")),xlab=substitute(paste("Observed ",italic('p-'), "value")))
dev.off()

#FIGURE 2D: now plot the histogram for p-value distributions
png("Figure2D.png",width=2000,height=2000, res = 300)
par(mfrow=c(2,1))
hist(n1_40_n2_60_SDR_0.5[,1], main=substitute(paste("Student's ",italic('t-'), "test")), xlab=substitute(paste("Observed ",italic('p-'), "value")))
hist(n1_40_n2_60_SDR_0.5[,2], main=substitute(paste("Welch's ",italic('t-'), "test")),xlab=substitute(paste("Observed ",italic('p-'), "value")))
dev.off()
