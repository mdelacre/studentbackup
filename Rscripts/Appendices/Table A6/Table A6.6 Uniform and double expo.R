...
setwd(dir="C:/Users/ULB/Dropbox/Welch vs. Students_final Scripts/Table A3 power for distributions/With extreme SDR/Uniform and double expo")
...
###### n=10 and r=1
	...
	write.table(power_rate,paste("Extreme and very extreme_uniform and doublex_n1=",power_rate[1,2],"and r=",power_rate[1,3],".txt"),sep=";",dec=",")
