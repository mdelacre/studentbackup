#########################################################
# PART 2: POWER : S1 = Unif(1,2) ; S2 = Unif(0,2*ratio) #
#########################################################
...
###### n=10 and r=0.5
	...
	power_bis=function(ratio){
		...
		generate=function(i){
			...
			sample1 <- runif(n1,-4.465,2.465) #simulate participants condition A, mean = 1
	...
	write.table(power_rate,paste("Two uniform_n1=",power_rate[1,2],"and r=",power_rate[1,3],".txt"),sep=";",dec=",")
