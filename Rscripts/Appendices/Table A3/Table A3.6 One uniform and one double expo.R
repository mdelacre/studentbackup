#################################################################
# PART 1: ALPHA RISK : S1 = Unif(0,2) ; S2 = DOUBLEX(0,2*ratio) #
#################################################################
...
setwd(dir="C:/Users/mdela/Dropbox/Welch vs. Students_final Scripts/Table A3 for different non normal distributions/Middle to big SS/Uniform and double expo")
...
###### n=10 and r=0.5
	...
	write.table(alpha_rate,paste("Uniform and double expo_n1=",alpha_rate[1,2],"and r=",alpha_rate[1,3],".txt"),sep=";",dec=",")
