...
setwd(dir="C:/Users/mdela/Dropbox/Welch vs. Students_final Scripts/Table A3 power for distributions/Medium to large SS/Normal")
...
###### n=10 and r=0.5
	...
	write.table(power_rate,paste("One normal_One double expo_n1=",power_rate[1,2],"and r=",power_rate[1,3],".txt"),sep=";",dec=",")
