####################################################
# POWER : S1 = Unif(0,2) ; S2 = DOUBLEX(1,2*ratio) #
####################################################
...
setwd(dir="C:/Users/ULB/Dropbox/Welch vs. Students_final Scripts/Table A3 power for distributions/Medium to large SS/Uniform and double expo")
...
###### n=10 and r=0.5
	...
	power_bis=function(ratio){
		...
		generate=function(i){
			...
			sample2 <- rdoublex(r*n1, mu=1, ratio*2)#simulate participants condition B, mean = 1
	...
	write.table(power_rate,paste("Uniform and double expo_n1=",power_rate[1,2],"and r=",power_rate[1,3],".txt"),sep=";",dec=",")
