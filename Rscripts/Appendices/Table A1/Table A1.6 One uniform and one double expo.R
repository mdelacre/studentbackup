...
setwd(dir="C:/Users/Admin/Documents/Github projects/studentbackup/scripts outputs/Appendices/Table A1/Table A1.6 One uniform, one double exponential")
...
###### n=10
	...
	alpha_bis=function(SDR){ 
		...
		generate=function(i){
			...
			sample2 <- rdoublex(n, mu=0, SDR*(2/sqrt(2)))#simulate participants condition B, as a default option, me
