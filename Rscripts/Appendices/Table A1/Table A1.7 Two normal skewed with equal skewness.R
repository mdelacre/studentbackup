...
setwd(dir="C:/Users/Admin/Documents/Github projects/studentbackup/scripts outputs/Appendices/Table A1/Table A1.7 Two normal skewed")
...
###### n=10
	...
	write.table(alpha_rate,paste("Alpha extr SDR_balanced_equal skewnorm_n1=n2=",alpha_rate[1],".txt"),sep=";",dec=",")
...
###### n=10
	...
	write.table(power_rate,paste("Power extr SDR_balanced_equal skewed_n1=n2=",power_rate[1],".txt"),sep=";",dec=",")
