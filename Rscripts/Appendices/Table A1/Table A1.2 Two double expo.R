##################################################################################################################################
#                            BALANCED DESIGNS WITH  S1 = DOUBLEX(0,2) ; S2 = DOUBLEX(0,2*SDR)                                     #
##################################################################################################################################
...
setwd(dir="C:/Users/Admin/Documents/Github projects/studentbackup/scripts outputs/Appendices/Table A1/Table A1.2 Two double exponential distributions")
...
###### n=10
	...
	alpha_bis=function(SDR){ 
		...
		generate=function(i){
			...
			sample1 <- rdoublex(n, mu=0, (2/sqrt(2))) #simulate participants condition A, as a default option, mean = 0
			sample2 <- rdoublex(n, mu=0, SDR*(2/sqrt(2)))#simulate participants condition B, as a default option, mean = 0
	...
	write.table(alpha_rate,paste("Alpha extr SDR_balanced design_Two double expo_n1=n2=",alpha_rate[1],".txt"),sep=";",dec=",")
...
###### n=10
	...
	power_bis=function(SDR){ 
		...
		generate=function(i){
			...
			sample1 <- rdoublex(n, mu=0, (2/sqrt(2))) #simulate participants condition A, as a default option, mean = 0
			sample2 <- rdoublex(n, mu=1, SDR*(2/sqrt(2)))#simulate participants condition B, mean = 1
	...
	write.table(power_rate,paste("Power extr SDR_balanced_Two double expo_n1=n2=",power_rate[1],".txt"),sep=";",dec=",")
